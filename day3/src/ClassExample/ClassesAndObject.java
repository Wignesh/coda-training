...
class LeatherShoe extends Shoe {
	...
	public LeatherShoe() {
		super(10);// this super will invoke the parent class contructor and remember this should
					// be the first line
	...
	// override annotation checks whether the method below is declared in the parent
	// class or not
